...
__NOTE:__ When installing the types with the LOKE cli this would still create the `CreateCustomerRequest` but as we have
...
__NOTE:__ When using the types generated by the LOKE cli in this cases you may have to pass an empty object as the request.
